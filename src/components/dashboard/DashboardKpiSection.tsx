  ...
  return (
    <>
      <section aria-labelledby="kpi-primary-heading">
        <h3 id="kpi-primary-heading" className="sr-only">
        ...
        <div className="kpi-grid-primary">
          ...
          <KpiCard
            title="CA du mois"
            value={formatMoney(kpis.caMois)}
            icon={TrendingUp}
            accent="accent"
            trend={kpis.variationCaPct}
          />
      ...
      <section aria-labelledby="kpi-secondary-heading">
        <h3
          id="kpi-secondary-heading"
          className="mb-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground"
        >
          Encaissements &amp; saisies
        </h3>
        <div className="kpi-grid-secondary">
          <KpiCard
            title="Encaissements"
            value={formatMoney(kpis.totalEncaissements)}
            icon={Wallet}
            accent="accent"
          />
          <KpiCard
          ...
          />
          <KpiCard
            title="Écart obj. / réalisé"
            value={formatMoney(kpis.ecartObjectif)}
            icon={Target}
            accent={kpis.ecartObjectif < 0 ? 'warning' : 'success'}
          />
          <KpiCard
            title="Saisies réalisées"
          ...
          <KpiCard
            ...
            icon={AlertTriangle}
            accent={kpis.saisiesManquantes > 0 ? 'warning' : 'neutral'}
          />
        </div>
      </section>
    </>
