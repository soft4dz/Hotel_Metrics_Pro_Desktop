...
export const MODULES: ModuleDefinition[] = [
  ...
  { id: 'stocks-consommations', order: 11, name: 'Stocks & consommations', group: 'Exploitation', status: 'operationnel', route: moduleRoute('stocks-consommations'), existingRoute: '/stocks', connectedTo: ['Achats & approvisionnements', 'Maintenance & interventions', 'Plage & piscine', 'Budget & prévisions'] },
