...
export const MODULES: ModuleDefinition[] = [
  ...
  { id: 'hebergement-occupation', order: 7, name: 'Hébergement & occupation', group: 'Exploitation', status: 'operationnel', route: moduleRoute('hebergement-occupation'), existingRoute: '/hebergement', connectedTo: ['Recettes journalières', 'Budget & prévisions', 'Qualité & réclamations clients', 'Commercial & partenariats'] },
  ...
  { id: 'rh-productivite', order: 14, name: 'RH & productivité', group: 'Ressources humaines', status: 'operationnel', route: moduleRoute('rh-productivite'), existingRoute: '/rh', connectedTo: ['Unités hôtelières', 'Recettes journalières', 'Budget & prévisions', 'Comparatif inter-unités'] },
  ...
  { id: 'commercial-partenariats', order: 23, name: 'Commercial & partenariats', group: 'Juridique & commercial', status: 'a-developper', route: moduleRoute('commercial-partenariats'), connectedTo: ['Contrats & conventions', 'Facturation', 'Créances & recouvrement', 'Hébergement & occupation'] },
