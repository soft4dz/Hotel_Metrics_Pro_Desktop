...
export const MODULES: ModuleDefinition[] = [
  ...
  { id: 'pos-restauration', order: 11.6, name: 'Points de vente (POS)', group: 'Exploitation', status: 'operationnel', route: moduleRoute('pos-restauration'), existingRoute: '/pos', connectedTo: ['Production & fiches techniques', 'Encaissements & trésorerie', 'Comptabilité SCF', 'Stocks & consommations', 'Plage & piscine', 'Parking'] },
  ...
  { id: 'plage-piscine', order: 19, name: 'Plage & piscine', group: 'Exploitation', status: 'operationnel', route: moduleRoute('plage-piscine'), existingRoute: '/plage', connectedTo: ['Points de vente (POS)', 'Recettes journalières', 'Encaissements & trésorerie', 'Stocks & consommations', 'Maintenance & interventions'] },
  { id: 'parking', order: 20, name: 'Parking', group: 'Exploitation', status: 'operationnel', route: moduleRoute('parking'), existingRoute: '/parking', connectedTo: ['Points de vente (POS)', 'Recettes journalières', 'Encaissements & trésorerie', 'Facturation', 'Rapports automatiques'] },
